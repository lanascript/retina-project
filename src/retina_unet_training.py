...
#=========== Transpose data from channels_first to channels_last format =====
...
#============  Training ==================================
checkpointer = ModelCheckpoint(filepath='./'+name_experiment+'/'+name_experiment +'_best_model.keras', verbose=1, monitor='val_loss', mode='auto', save_best_only=True) #save at each epoch if the validation decreased
...
model.save('./'+name_experiment+'/'+name_experiment +'_last_model.keras')
#test the model
